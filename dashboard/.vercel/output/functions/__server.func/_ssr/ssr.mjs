...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-vq2NStj2.mjs");
...
var manifest = {
	"02ee2a7257e03290d04a9f4cd895d2734de26148db37d1170aa472f82ca2aa54": {
		functionName: "loadWorkspace_createServerFn_handler",
		importer: () => import("./ops-pm4IH2aY.mjs")
	},
	"23aa098b570397bf309442202ebdeb1ef5ce54353031954578fad9e0ce229605": {
		functionName: "briefFinding_createServerFn_handler",
		importer: () => import("./ops-pm4IH2aY.mjs")
	},
	"5174c3986578819c0fb5c15a08041ef0dae703f70fe9effe8a4ac78b04095cd9": {
		functionName: "createCase_createServerFn_handler",
		importer: () => import("./ops-pm4IH2aY.mjs")
	},
	"6d3a07c3e21485a2067f241cb7c5f786462a705c99259e30810144a687e7698d": {
		functionName: "addEvidence_createServerFn_handler",
		importer: () => import("./ops-pm4IH2aY.mjs")
	},
	"7d913717709f9e82d2314958a826542e43dbfb6ceb8d5c0b1450c1e320e8f2dd": {
		functionName: "loadCase_createServerFn_handler",
		importer: () => import("./ops-pm4IH2aY.mjs")
	},
	"ceb56b0651a0eda36ef2b015d3ed72664a9596e467dac27031b3ec90251e775e": {
		functionName: "dispatchDisrupt_createServerFn_handler",
		importer: () => import("./ops-pm4IH2aY.mjs")
	},
	"def6a5d935214b59d9fe0868b0dd8415ed4ac6805f801e102c3c29eebdea156e": {
		functionName: "dispatchInvestigate_createServerFn_handler",
		importer: () => import("./ops-pm4IH2aY.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-T8nvpqDu.mjs").then((n) => n.t),
